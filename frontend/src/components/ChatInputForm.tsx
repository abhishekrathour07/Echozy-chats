...
const ChatInputForm: React.FC = () => {
    ...
    return (
        <Form {...form}>
        <div className="flex items-center gap-2 bg-slate-800 p-4 border-t border-gray-600 relative w-full">
                        ...
                        <FormItem>
                            <FormControl>
                                <Input
                                    ...
                                    className="h-10 bg-slate-700 text-white rounded-lg px-4 focus:ring-[#f56565] focus:border-none w-full"
                                    {...field}
                                />
                            </FormControl>
                        </FormItem>
